...
export const EFFECT_TYPE_DATA = {
  ...
  damageInflicted: { id: 'damageInflicted', rawIds: [1], text: '% Damage Inflicted' },
  healthPoints: { id: 'healthPoints', rawIds: [20, 21], text: 'HP' },
  // healthPointReduction: { id: 'healthPointReduction', rawId: 21, text: 'HP', isNegative: true },
  healthSteal: { id: 'healthSteal', rawIds: [24], text: 'Health Steal' },
  healingMastery: { id: 'healingMastery', rawIds: [26], text: 'Healing Mastery' },
  actionPoints: { id: 'actionPoints', rawIds: [31, 56], text: 'AP' },
  ...
  movementPoints: { id: 'movementPoints', rawIds: [41, 42, 57], text: 'MP' },
  ...
  rearResistance: { id: 'rearResistance', rawIds: [71, 1063], text: 'Rear Resistance' },
  elementalResistance: { id: 'elementalResistance', rawIds: [80, 90], text: 'Elemental Resistance' },
  fireResistance: { id: 'fireResistance', rawIds: [82, 97], text: 'Fire Resistance' },
  waterResistance: { id: 'waterResistance', rawIds: [83, 98], text: 'Water Resistance' },
  earthResistance: { id: 'earthResistance', rawIds: [84, 96], text: 'Earth Resistance' },
  airResistance: { id: 'airResistance', rawIds: [85], text: 'Air Resistance' },
  ...
  elementalMastery: { id: 'elementalMastery', rawIds: [120, 130], text: 'Elemental Mastery' },
  fireMastery: { id: 'fireMastery', rawIds: [122, 132], text: 'Fire Mastery' },
  earthMastery: { id: 'earthMastery', rawIds: [123], text: 'Earth Mastery' },
  waterMastery: { id: 'waterMastery', rawIds: [124], text: 'Water Mastery' },
  airMastery: { id: 'airMastery', rawIds: [125], text: 'Air Mastery' },
  ...
  criticalMastery: { id: 'criticalMastery', rawIds: [149, 1056], text: 'Critical Mastery' },
  criticalHit: { id: 'criticalHit', rawIds: [150, 168], text: '% Critical Hit' },
  range: { id: 'range', rawIds: [160, 161], text: 'Range' },
  // rangeReduction: { id: 'range', rawId: 161, text: 'Range', isNegative: true },
  prospecting: { id: 'prospecting', rawIds: [162], text: 'Prospecting' },
  wisdom: { id: 'wisdom', rawIds: [166], text: 'Wisdom' },
  // criticalHitReduction: { id: 'criticalHitReduction', rawId: 168, text: '% Critical Hit', isNegative: true },
  initiative: { id: 'initiative', rawIds: [171, 172], text: 'Initiative' },
  // initiativeReduction: { id: 'initiativeReduction', rawId: 172, text: 'Initiative', isNegative: true },
  lock: { id: 'lock', rawIds: [173, 174], text: 'Lock' },
  // lockReduction: { id: 'lockReduction', rawId: 174, text: 'Lock', isNegative: true },
  dodge: { id: 'dodge', rawIds: [175, 176], text: 'Dodge' },
  // dodgeReduction: { id: 'dodgeReduction', rawId: 176, text: 'Dodge', isNegative: true },
  forceOfWill: { id: 'forceOfWill', rawIds: [177], text: 'Force of Will' },
  rearMastery: { id: 'rearMastery', rawIds: [180, 181], text: 'Rear Mastery' },
  // rearMasteryReduction: { id: 'rearMasteryReduction', rawId: 181, text: 'Rear Mastery', isNegative: true },
  control: { id: 'control', rawIds: [184], text: 'Control' },
  wakfuPoints: { id: 'wakfuPoints', rawIds: [191, 192, 194], text: 'Wakfu Points' },
  ...
  // skipped 843
  // skipped 865
  percentBlock: { id: 'percentBlock', rawIds: [875, 876], text: '% Block' },
  ...
  criticalResistance: { id: 'criticalResistance', rawIds: [988, 1062], text: 'Critical Resistance' },
  // skipped 1020. only used by the Makabrakfire Ring
  meleeMastery: { id: 'meleeMastery', rawIds: [1052, 1059], text: 'Melee Mastery' },
  distanceMastery: { id: 'distanceMastery', rawIds: [1053, 1060], text: 'Distance Mastery' },
  berserkMastery: { id: 'berserkMastery', rawIds: [1055, 1061], text: 'Berserk Mastery' },
  ...
  randomElementalMasteries: { id: 'randomElementalMasteries', rawIds: [1068], text: 'Gain ?? Random Elemental Masteries' },
  randomElementalResistances: { id: 'randomElementalResistances', rawIds: [1069], text: 'Gain ?? Random Elemental Resistances' },
  // skipped 1083
  // skipped 1084
  harvestingQuantity: { id: 'harvestingQuantity', rawIds: [2001], text: 'Harvesting Quantity' }, // TODO figure this one out

  // ones below this point were picked out manually
  armorGiven: { id: 'armorGiven', rawIds: [10000], text: '% Armor Given' },
  armorReceived: { id: 'armorReceived', rawIds: [10001], text: '% Armor Received' },
  healsPerformed: { id: 'healsPerformed', rawIds: [10002], text: '% Heals Performed' },
  indirectDamageInflicted: { id: 'indirectDamageInflicted', rawIds: [10003], text: '% Indirect Damage Inflicted' },
  dodgeOverride: { id: 'dodgeOverride', rawIds: [10004], text: 'Dodge Override' },
  healsReceived: { id: 'healsReceived', rawIds: [10005], text: '% Heals Received' },
  healthPointsFromLevel: { id: 'healthPointsFromLevel', rawIds: [10006], text: 'Health Points from Level' },
  lockOverride: { id: 'lockOverride', rawIds: [10007], text: 'Lock Override' },
  percentHealthPoints: { id: 'percentHealthPoints', rawIds: [10008], text: '% Health Points' },
  lockDoubled: { id: 'lockDoubled', rawIds: [10009], text: 'Lock Doubled' },
  dodgeFromLevel: { id: 'dodgeFromLevel', rawIds: [10010], text: 'Dodge from Level' },
  lockFromLevel: { id: 'lockFromLevel', rawIds: [10011], text: 'Lock from Level' },
  percentDodge: { id: 'percentDodge', rawIds: [10012], text: '% Dodge' },
};
