...
export const EFFECT_TYPE_DATA = {
  ...
  fireMastery: { id: 'fireMastery', rawIds: [122, 132], text: 'constants.fireResistance' },
  earthMastery: { id: 'earthMastery', rawIds: [123], text: 'constants.earthResistance' },
  waterMastery: { id: 'waterMastery', rawIds: [124], text: 'constants.waterResistance' },
