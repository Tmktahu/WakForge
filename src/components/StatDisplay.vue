    ...
    <div class="flex justify-content-between w-full px-2">
      <div class="main-stat-box">
        <div class="flex align-items-center my-1">
          <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/health_points.png" style="height: 20px" image-style="height: 20px" />
      ...
      <div class="main-stat-box">
        <div class="flex align-items-center my-1">
          <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/armor.png" style="height: 20px" image-style="height: 20px" />
      ...
      <div class="main-stat-box">
        <div class="flex align-items-center my-1">
          <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/action_points.png" style="height: 20px" image-style="height: 20px" />
      ...
      <div class="main-stat-box">
        <div class="flex align-items-center my-1">
          <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/movement_points.png" style="height: 20px" image-style="height: 20px" />
      ...
      <div v-if="currentCharacter.class === CLASS_CONSTANTS.huppermage" class="main-stat-box">
        <div class="flex align-items-center my-1">
          <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/quadrumental_breeze.png" style="height: 20px" image-style="height: 20px" />
    ...
    <div class="main-stat-area flex flex-column mt-2 pb-2">
      ...
      <div class="lex flex-column">
        ...
        <div class="flex pl-1">
          <div class="flex flex-column flex-grow-1" style="max-width: 50%">
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/damage_inflicted.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/critical_hit.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/initiative.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/dodge.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/wisdom.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/control.png" style="height: 20px" image-style="height: 20px" />
          ...
          <div class="flex flex-column flex-grow-1" style="max-width: 50%">
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/heals_performed.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/block.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/range.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/lock.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/prospecting.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/force_of_will.png" style="height: 20px" image-style="height: 20px" />
      ...
      <div class="flex flex-column">
        ...
        <div class="flex pl-1">
          <div class="flex flex-column flex-grow-1" style="max-width: 50%">
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/critical_mastery.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/rear_mastery.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/melee_mastery.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/distance_mastery.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/healing_mastery.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/berserk_mastery.png" style="height: 20px" image-style="height: 20px" />
          ...
          <div class="flex flex-column flex-grow-1" style="max-width: 50%">
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/critical_resistance.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/rear_resistance.png" style="height: 20px" image-style="height: 20px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/armor_given.png" style="height: 20px" image-style="height: 16px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/armor_received.png" style="height: 20px" image-style="height: 16px" />
            ...
            <div class="stat-block pr-2">
              <p-image src="https://tmktahu.github.io/WakfuAssets/statistics/indirect_damage.png" style="height: 20px" image-style="height: 20px" />
